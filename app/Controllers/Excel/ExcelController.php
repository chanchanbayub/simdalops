    ...
    public function index()
    {
        ...
        foreach ($suratPengeluraan as $pengeluaran) {
            $spreadSheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('E' . $column, $pengeluaran["jenis_pelanggaran"])
    ...
    public function arsip_laporan()
    {
        ...
        foreach ($laporan_harian as $laporan) {
            $spreadSheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('K' . $column, $laporan["jenis_pelanggaran"])
                ->setCellValue('L' . $column, $laporan["pasal_pelanggaran"])
    ...
    public function exportLaporanPenindakan($keyword)
    {
        ...
        foreach ($data as $laporan) {
            $spreadSheet->setActiveSheetIndex(0)
                ...
                ->setCellValue('J' . $column, $laporan["jenis_pelanggaran"])
                ->setCellValue('K' . $column, $laporan["pasal_pelanggaran"])
