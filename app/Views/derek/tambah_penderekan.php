                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> Tambah Penindakan Unit / Regu </h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form id="tambah_penderekan">
                                <?= csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ukpd_id" id="ukpd_id" class="form-control" value="Dalops" readonly>
                                        </div>
                                        <div class="form-group">
...
<script>
    ...
    $("#jenis_kendaraan_id").change(function(e) {
        ...
        $.ajax({
            url: '/derek/getKlasifikasiKendaraan',
            dataType: 'json',
            data: {
    ...
    $("#tambah_penderekan").submit(function(e) {
        e.preventDefault();
