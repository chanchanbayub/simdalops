        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                            ...
                            <ul class="nav flex-column bg-white">
                                <table class="table bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($pengeluaran["scan_pengantar_sidang"] != NULL) : ?>
                                            <td style="width: 20px; text-align:center"> <i class="fa fa-check"></i> </a></td>
                                        <?php else : ?>
                                            <td style="width: 20px; text-align:center"> <i class="fa fa-times"></i></td>
                                        <?php endif; ?>
                                    </tr>
                                    <tr>
                                        ...
                                        <td> Fotocopy KTP </td>
                                        <?php if ($pengeluaran["scan_ktp"] != NULL) : ?>
                                            <td style="width: 20px; text-align:center"> <i class="fa fa-check"></i></td>
                                        <?php else : ?>
                                            <td style="width: 20px; text-align:center"> <i class="fa fa-times"></i></td>
                                        <?php endif; ?>
                                ...
                                <table class="table bg-white table-responsive ">
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <?php if ($pengeluaran["status_surat_id"] == 1 || $pengeluaran["status_surat_id"] == 2 || $pengeluaran["status_surat_id"] == 3) : ?>
                    ...
                    <!-- /.widget-user -->
                    <?php if ($pengeluaran["status_surat_id"] == 1) : ?>
                        <div class="col-md-12">
                                ...
                                <form id="paraf" autocomplete="off" method="POST">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="status_surat_id" id="status_surat_id" value="2">
                                            <label for="catatan_lain"> Catatan :</label>
                                            <input type="text" name="catatan_lain" style="text-transform: capitalize;" id="catatan_lain" class="form-control" placeholder="Silahkan Masukan Catatan">
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
                                    <div class="card-footer text-center"> <button type="submit" class="btn btn-outline-success btn-md save">
                                            <i class="fa fa-signature"></i> Paraf
                                        </button>
                                    </div>
                                </form>
                            </div>
...
<script>
    $(".save").click(function(e) {
        e.preventDefault();
        let id = $("#id").val();
        let catatan_lain = $("#catatan_lain").val();
        let status_surat_id = $("#status_surat_id").val();

        $.ajax({
            url: '/kasie/surat_masuk/update_surat',
            dataType: 'JSON',
            type: 'POST',
            data: {
                id: id,
            ...
            success: function(response) {
                ...
                setInterval(() => {
                    window.location.href = '/kasie/surat_masuk';
                }, 500);
            }
        });
    });
