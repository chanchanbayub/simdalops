            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <button type="button" class="btn btn-inline btn-outline-dark btn-sm mb-3" id="modal-save" data-toggle="modal" data-target="#add-status"> <i class="fa fa-plus"></i> Tambah Status Surat </button>
                                    ...
                                    if (count($status) > 0) :
                                        foreach ($status as $status) : ?>
                                            <tr>
                                                ...
                                                <td><?= $status["name"] ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-inline bg-gradient-warning btn-sm edit" data-toggle="modal" data-target="#add-status" data-id="<?= $status["id"] ?>"> <i class="fa fa-edit"></i></button>
                                                    <button type="button" data-toggle="modal" data-target="#delete-status" data-id="<?= $status["id"] ?>" class="btn btn-inline bg-gradient-danger btn-sm delete-data"> <i class="fa fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
            ...
            <div class="modal-body">
                <form method="post" autocomplete="off" autofocus>
                    ...
                    <div class="form-group">
                        <label for="status" class="col-form-label">Status Surat :</label>
                        <input type="text" style="text-transform: capitalize;" class="form-control" id="status" name="name" placeholder="Masukan Status Surat">
            ...
            success: function(response) {
                ...
                if (response.error) {
                    ...
                    if (response.error.name) {
                        ...
                        $("#errorStatus").html(response.error.name);
                    } else {
