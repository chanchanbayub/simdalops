...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <h5 class="mt-4 mb-2">Laporan Penindakan Harian Regu (<?= session('unit_penindak') ?>) </h5>
            <div class="row">
                <div class="col-md-12 col-md-6 col-12">
                    <div class="info-box bg-info">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= $jumlahPenindakan ?> Kendaraan</span>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-success">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"> <?= $totalBapAktif ?> Lembar</span>
                ...
                <div class="col-md-3 col-sm-6 col-12">
                    <div class="info-box bg-danger">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?= $totalBapMasuk ?> Lembar</span>
