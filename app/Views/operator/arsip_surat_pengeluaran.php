                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Surat Pengeluaran</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    foreach ($suratPengeluaran as $pengeluaran) : ?>
                                        <tr align="center">
                                            ...
                                            <td style="vertical-align: middle;" style="display: inline-block;">
                                                <?php if ($pengeluaran["status_surat_id"] == 4) : ?>
                                                    <a href="/surat_pengeluaran/<?= $pengeluaran["id"] ?>" target="_blank" class="btn btn-outline-success btn-xs"> <i class=" fa fa-print"></i></a>
                                                <?php endif; ?>
                                                <button class="btn  btn-outline-danger btn-xs" data-toggle="modal" data-target="#modal-delete" id="hapus" data-id="<?= $pengeluaran["id"] ?>"> <i class="fa fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else : ?>
