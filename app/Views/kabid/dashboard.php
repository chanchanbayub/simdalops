...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
                    ...
                    <div class="col-md-12 col-md-6 col-12">
                        <div class="info-box bg-danger">
                            ...
                            <div class="info-box-content">
                                ...
                                <span class="info-box-text"><a style="color: white;" class="btn btn-outline-secondary" href="/kabid/profile"> <i class="fas fa-hand-pointer"></i> Klik Disini!</a></span>
            ...
            <!-- /.row -->
            <h5 class="mt-4 mb-2">Laporan Jumlah Pengeluaran </h5>
            <div class="row">
